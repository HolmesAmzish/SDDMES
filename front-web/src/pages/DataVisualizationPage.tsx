...
export default function DataVisualizationPage() {
  ...
  const renderCharts = () => {
    ...
    const defectTypeChart = echarts.init(
      document.getElementById("defect-type-chart")!
    );
    ...
    const defectNumChart = echarts.init(
      document.getElementById("defect-num-chart")!
    );
    defectNumChart.setOption({
      ...
      xAxis: {
        type: "category",
        data: Object.keys(data.defectNumberDistribution),
      },
      yAxis: { type: "value" },
      series: [
        {
    ...
    dailyChart.setOption({
      ...
      xAxis: {
        type: "category",
        data: data.dailyDetectionCounts.map((d) => d.date),
      },
      yAxis: { type: "value" },
      series: [
        {
    ...
    recentChart.setOption({
      ...
      xAxis: {
        type: "category",
        data: data.recentDefectSummaries.map((d) => d.date),
      },
      yAxis: { type: "value" },
      series: [
        {
